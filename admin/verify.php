              ...
              <div class="card-body">
                <table id="example1" class="table table-dark table-striped">
                  ...
                  <tr>
                    ...
                    <th>No. of freelance</th>
                    <th>Experience</th>
                    <th>Payment for freelance</th>
                    <th>Budget</th>
                  ...
                  <tbody>
                    <?php
                      $query = $db->query("SELECT * FROM job_db"); //Eto yung query
                    ...
                    <tr>
                      ...
                      <td><?= $freelancer['type_of_project']; ?></td>
                      <td><?= $freelancer['no_of_freelance']; ?></td>
                      <td><?= $freelancer['experience']; ?></td>
                      <td><?= $freelancer['payment_freelance']; ?></td>
                      <td><?= $freelancer['budget']; ?></td>
                      <td><?= $freelancer['mode_of_payment']; ?></td>
                      <td>
                      <div>
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Accept
                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">Decline
                        </div>
                      </td>
                    </tr>
