<?php
  ...
  if(isset($_POST['submit_achievement_btn'])){
    ...
    if($move){
      ...
      $r = $db->query($sql);
      header("Location: ../admin/training_profile.php?edit=$id");
    }
  }
  ...
  if($_POST){
      ...
      if (!empty($_FILES['primary']['name'])) {
        ...
        if (in_array($extension, $allowed_type)) {
          for ($i = 0; $i < count($allowed_type) ; $i++) { 
            if(file_exists("../uploads/documents/trainor/".$id."_"."primary_id.".$allowed_type[$i])){
              chmod("/var/www/html/uploads/documents/trainor/".$id."_"."primary_id.".$allowed_type[$i], 0777);
              unlink("/var/www/html/uploads/documents/trainor/".$id."_"."primary_id.".$allowed_type[$i]);
            }
          }
          chmod("/var/www/html/uploads/documents/trainor/".$new_name, 0777);
          $move = move_uploaded_file($from_dir, "/var/www/html/uploads/documents/trainor/".$new_name);
          if ($move) {
          } else{
    ...
    if(isset($_FILES['secondary']['name'])){
      if (!empty($_FILES['secondary']['name'])) {
        ...
        if (in_array($extension, $allowed_type)) {
          for ($i = 0; $i < count($allowed_type) ; $i++) { 
            if(file_exists("../uploads/documents/trainor/".$id."_"."secondary_id.".$allowed_type[$i])){
              chmod("/var/www/html/uploads/documents/trainor/".$id."_"."secondary_id.".$allowed_type[$i], 0777);
              unlink("/var/www/html/uploads/documents/trainor/".$id."_"."secondary_id.".$allowed_type[$i]);
            }
          }
          chmod("/var/www/html/uploads/documents/trainor/".$new_name, 0777);
          $move = move_uploaded_file($from_dir, "/var/www/html/uploads/documents/trainor/".$new_name);
    ...
    if(isset($_FILES['certificate']['name'])){
      if (!empty($_FILES['certificate']['name'])) {
        ...
        if (in_array($extension, $allowed_type)) {
          for ($i = 0; $i < count($allowed_type) ; $i++) { 
            if(file_exists("/var/www/html/uploads/documents/trainor/".$id."_"."certificate_id.".$allowed_type[$i])){
              chmod("/var/www/html/uploads/documents/trainor/".$id."_"."certificate_id.".$allowed_type[$i], 0777);
              unlink("/var/www/html/uploads/documents/trainor/".$id."_"."certificate_id.".$allowed_type[$i]);
            }
          }
          chmod("/var/www/html/uploads/documents/trainor/".$new_name, 0777);
          $move = move_uploaded_file($from_dir, "/var/www/html/uploads/documents/trainor/".$new_name);
    ...
    if(isset($_FILES['barangay_clearance']['name'])){
      if (!empty($_FILES['barangay_clearance']['name'])) {
        ...
        if (in_array($extension, $allowed_type)) {
          for ($i = 0; $i < count($allowed_type) ; $i++) { 
            if(file_exists("../uploads/documents/trainor/".$id."_"."barangay_clearance_id.".$allowed_type[$i])){
              chmod("/var/www/html/uploads/documents/trainor/".$id."_"."barangay_clearance_id.".$allowed_type[$i], 0777);
              unlink("/var/www/html/uploads/documents/trainor/".$id."_"."barangay_clearance_id.".$allowed_type[$i]);
            }
          }
          chmod("/var/www/html/uploads/documents/trainor/".$new_name, 0777);
          $move = move_uploaded_file($from_dir, "/var/www/html/uploads/documents/trainor/".$new_name);
    ...
    if(isset($_FILES['diploma']['name'])){
      if (!empty($_FILES['diploma']['name'])) {
        ...
        if (in_array($extension, $allowed_type)) {
          for ($i = 0; $i < count($allowed_type) ; $i++) { 
            if(file_exists("../uploads/documents/trainor/".$id."_"."diploma_id.".$allowed_type[$i])){
              chmod("/var/www/html/uploads/documents/trainor/".$id."_"."diploma_id.".$allowed_type[$i], 0777);
              unlink("/var/www/html/uploads/documents/trainor/".$id."_"."diploma_id.".$allowed_type[$i]);
            }
          }
          chmod("/var/www/html/uploads/documents/trainor/".$new_name, 0777);
          $move = move_uploaded_file($from_dir, "/var/www/html/uploads/documents/trainor/".$new_name);
    ...
    if (!empty($_FILES['profile']['name'])) {
      ...
      $from_dir = $file['tmp_name'];
      $extension = pathinfo($whole_filename, PATHINFO_EXTENSION);
      $name = $id."_"."trainor.".$extension;
      $new_name = strtolower($name);
      $new_dir = $to_dir.$new_name;
      if (in_array($extension, $allowed_type)) {
        for ($i = 0; $i < count($allowed_type) ; $i++) { 
          if(file_exists("../uploads/profile/trainor/".$id."_"."trainor.".$allowed_type[$i])){
            chmod("/var/www/html/uploads/documents/trainor/".$id."_"."trainor.".$allowed_type[$i], 0777);
            unlink("/var/www/html/uploads/profile/trainor/".$id."_"."trainor.".$allowed_type[$i]);
          }
        }
        $move = move_uploaded_file($from_dir, "/var/www/html/uploads/profile/trainor/".$new_name);
        if ($move) {
        } else{
    ...
    if (empty($error)) {
      ...
      echo "<script>window.location='../admin/training_profile.php?edit=$id'</script>";
      }
    } else {
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-5" id="navbarCollapse">
            ...
            <ul class="nav nav-tabs ml-3 p-3">
              ...
              <li class="nav-item">
                <a href="../trainor.php" class="nav-link text-secondary">Home</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <div>
    <div class="container">
                    ...
                    <div class="form-group">
                      ...
                      <div class="d-flex">
                                  <?php if(!empty($result['profile_picture'])) :?>
                                    <img src="../uploads/profile/trainor/<?= $result['profile_picture']?>" 
      ...
      <div class="container">
                          ...
                          <div class="form-group mt-3">
                              ...
                              <div class="d-flex">
                                  <?php if(!empty($result['primary_id'])) :?>
                                    <img src="../uploads/documents/trainor/<?= $result['primary_id']?>" 
                                    height="50px" width="50px"
                                    class="img-circle mr-2" alt="">
                                  <?php endif; ?>
                          ...
                          <div class="form-group mt-3">
                              ...
                              <div class="d-flex">
                                  <?php if(!empty($result['secondary_id'])) :?>
                                    <img src="../uploads/documents/trainor/<?= $result['secondary_id']?>" 
                                    height="50px" width="50px"
                                    class="img-circle mr-2" alt="">
                                  <?php endif; ?>
                          ...
                          <div class="form-group mt-3">
                                ...
                                <div class="d-flex">
                                  <?php if(!empty($result['diploma'])) :?>
                                    <img src="../uploads/documents/trainor/<?= $result['diploma']?>" 
                                    height="50px" width="50px"
                                    class="img-circle mr-2" alt="">
                                  <?php endif; ?>
                          ...
                          <div class="form-group mt-3">
                                ...
                                <div class="d-flex">
                                  <?php if(!empty($result['barangay_clearance'])) :?>
                                    <img src="../uploads/documents/trainor/<?= $result['barangay_clearance']?>" 
                                    height="50px" width="50px"
                                    class="img-circle mr-2" alt="">
                                  <?php endif; ?>
                                  <div style="border: 1px solid lightgrey;
        ...
        <?php endif; ?>
        <div class="mb-5">
                <input type="submit" value="<?php $account_status != 2? print('Submit Profile'): print('Save'); ?>" name="submit" class="btn btn-primary"
