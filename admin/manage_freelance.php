<?php
  ...
  if(isset($_GET['edit'])){
    $id = $_GET['edit']; 
    $query = $db->query("SELECT * FROM freelance WHERE flid = '$id'");
  ...
  if($_POST){
    ...
    if(isset($_GET['edit'])){
      $query = $db->query("UPDATE freelance SET `firstname` = '$firstname', `lastname` = '$lastname', `middlename` = '$middle', `birthday` = '$birthday', `age` = '$age', `address` = '$address', `skills` = '$skills' WHERE `flid` = '$id'");
      echo '<script>
        alert("Updated!");
        window.location="data.php";
      </script>';
    }else{
      $query = $db->query("INSERT INTO freelance(`firstname`, `lastname`, `middlename`, `birthday`, `age`, `address`, `skills`) VALUES ('$firstname', '$lastname', '$middle', '$birthday', '$age', '$address', '$skills')");
      echo '<script>
        alert("Added!");
        window.location="data.php";
      </script>';
              ...
              <form id="quickForm" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="skills" value="<?= $skills; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter Skills">
                  </div>
