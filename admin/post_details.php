  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="card card-dark">
              ...
              <div class="card-body">
              <?php
                $validate = $db->query("SELECT id FROM service_proposal WHERE reg_id = '$reg_id' AND service_id = '$service_id' AND delete_flg = '0';");

                if (mysqli_num_rows($validate) < 1) {
              ?>
                <button class="btn btn-primary" style="float: right;" onclick="hire_now('<?=$service_id?>', '<?=$reg_id?>')">Hire</button>
              <?php
                }
              ?>
