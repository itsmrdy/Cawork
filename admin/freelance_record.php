            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-dark table-striped">
                  ...
                  <tbody>
                    <?php
                      $query = $db->query("SELECT * FROM reg_db WHERE `user_type_id` ='2' AND status = '2';"); //Eto yung query
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Skilled Worker Profile</h5>
                          </div>
