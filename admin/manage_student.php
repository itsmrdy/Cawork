<?php
  ...
  if(isset($_GET['edit'])){
    $id = $_GET['edit']; 
    $query = $db->query("SELECT * FROM student WHERE studentid = '$id'");
  ...
  if($_POST){
    ...
    if(isset($_GET['edit'])){
      $query = $db->query("UPDATE student SET `firstname` = '$firstname', `lastname` = '$lastname', `middlename` = '$middle', `birthday` = '$birthday', `age` = '$age', `address` = '$address', `course` = '$course' WHERE `student` = '$id'");
      echo '<script>
        alert("Updated!");
        window.location="student.php";
      </script>';
    }else{
      $query = $db->query("INSERT INTO student(`firstname`, `lastname`, `middlename`, `birthday`, `age`, `address`, `course`) VALUES ('$firstname', '$lastname', '$middle', '$birthday', '$age', '$address', '$course')");
      echo '<script>
        alert("Added!");
        window.location="student.php";
      </script>';
              ...
              <form id="quickForm" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="course" value="<?= $course; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter Course">
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="student.php" class="btn btn-default">Cancel</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
